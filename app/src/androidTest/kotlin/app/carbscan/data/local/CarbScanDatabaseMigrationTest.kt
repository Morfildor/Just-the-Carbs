 ...
 * decision).
 */
class CarbScanDatabaseMigrationTest {
    ...
    fun migratingFromV2PreservesAnExistingVerifiedFavouriteProduct() {
        ...
        val migrated = helper.runMigrationsAndValidate(TEST_DB, 3, true, CarbScanDatabase.MIGRATION_2_3)
    ...
    fun aNewPortionUnitCanBeInsertedAndReadBackAfterMigration() {
        ...
        // which checks it against a normally-opened CarbScanDatabase (the real production path)

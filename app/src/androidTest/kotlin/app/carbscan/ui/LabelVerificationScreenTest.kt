...
import app.carbscan.ui.product.LabelVerificationDialog
import app.carbscan.ui.product.VERIFY_CONFIRM_TAG
import app.carbscan.ui.product.VERIFY_USE_PACKAGE_TAG
...
class LabelVerificationScreenTest {
    ...
    fun anIncomparableBasisExplainsItselfAndOffersNoWayToApplyTheValue() {
        ...
        compose.onNodeWithText("CarbScan does not convert", substring = true).assertIsDisplayed()

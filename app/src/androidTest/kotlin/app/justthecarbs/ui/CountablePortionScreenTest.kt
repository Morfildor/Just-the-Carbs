...
import app.justthecarbs.ui.product.ADD_PORTION_UNIT_FIELD_TAG
import app.justthecarbs.ui.product.PORTION_CORRECTION_FIELD_TAG
 ...
 * [app.justthecarbs.ui.product.ProductViewModel] does, so the test exercises the real screen and the
...
class CountablePortionScreenTest {
    ...
    /** Full local-state harness, matching [app.justthecarbs.ui.product.ProductViewModel]'s own logic. */
    ...
    fun correctingTheOnlinePortionWeightInlineUsesTheCorrectedValue() {
        ...
        assertSpokenResultOnceTheKeyboardCloses("31.9 grams of carbs")

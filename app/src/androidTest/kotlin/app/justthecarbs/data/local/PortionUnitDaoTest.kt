 ...
 * connection path [JustTheCarbsDatabase.build] uses in production — deliberately, not
 ...
 * answer the real question — does a real, normally-opened [JustTheCarbsDatabase] enforce the
...
class PortionUnitDaoTest {
    ...
    private fun sliceUnit(barcode: String) = app.justthecarbs.domain.PortionUnit(
